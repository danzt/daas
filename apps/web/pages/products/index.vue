...
<template>
  <div>
    <!-- MOBILE — exclusive screen -->
    <MobileScreensProducts
      v-if="isMobile"
      :products="products"
    ...
    <div v-else class="p-4 sm:p-6 space-y-5">
      ...
      <!-- Filter bar -->
      <div
        class="rounded-xl border bg-card shadow-sm px-4 py-3 sm:px-5 sm:py-4"
      >
        ...
        >
          ...
          <div class="flex flex-col flex-1 p-2.5 sm:p-3 gap-1">
            ...
            <div class="mt-auto pt-2">
              <p
                class="text-sm sm:text-base font-bold text-foreground font-mono"
              >
                {{ formatPrice(product) }}
              </p>
              <p
    ...
    <!-- Product form modal (shared web + mobile) -->
    <ProductFormModal
